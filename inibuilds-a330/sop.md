...
*   **Abschluss des Boardings / Cargo Loadings:** Nach Abschluss des Beladungs-/Boardingprozesses Jetway trennen bzw. Main Deck Cargo Door über das EFB schließen.
...
*   **Parking Position & Shutdown:**
    ...
    *   Über das EFB den Jetway / Cargo Loader anfordern (falls GPU genutzt wird: **EXT PWR** auf **ON** schalten).
...
*   **Engine Shutdown Flow:**
    ...
    *   **SEAT BELTS** auf **OFF** schalten (akustisches Signal zum Abschnallen/Aussteigen).
