...
* **Ablaufkette des Transits:**
  * **[1. Arrival, Parking & Transit Setup](#1-arrival-parking--transit-setup):** Ankunft am Standplatz, Feststellbremse setzen, Übernahme auf APU BLEED und Abstellen der Triebwerke.
  * **[2. Deboarding, Refueling & Boarding via EFB](#2-deboarding-refueling--boarding-via-efb):** Passagier- Deboarding bzw. ULD Cargo Unloading, Refueling (Betankung bei laufender APU) und anschließendes Boarding / Cargo Loading des Folgesegments.
...
- [2. Deboarding, Refueling & Boarding via EFB](#2-deboarding-refueling--boarding-via-efb)
...
Nachdem das Flugzeug am Gate oder Cargo Stand positioniert, die Parkbremse gesetzt und die Klimatisierung auf APU BLEED übernommen wurde (siehe [Standard SOP – Abschnitt 7: After Landing, Taxi & Shutdown](sop.md#7-after-landing-taxi--shutdown)), beginnt der Transit-Prozess ohne vollständiges Herunterfahren des Flugzeugs:
...
*   **Cockpit Leftover Management & Bodensicherheit (Transit-Zustand):**
    ...
    *   **Anti-Glare & Ground Crew Safety:** **NOSE** Light und **RWY TURN OFF** Lights werden sofort nach dem Anhalten am Standplatz auf **OFF** geschaltet, um Marshaller, Jetway-Operator und Bodenpersonal nicht zu blenden.
    ...
    *   **Passagier- & Kabinensignale:** **SEAT BELTS** auf **OFF** schalten, **NO SMOKING** auf **ON** oder **AUTO** und **EMER EXIT LT** auf **ARM** belassen.
    *   **BRK FAN:** ECAM WHEEL-Seite prüfen. Bei Bremstemperaturen über 150°C am Standplatz auf **ON** schalten.

---

### 2. Deboarding, Refueling & Boarding via EFB
Die Steuerung der Bodenabfertigung erfolgt über das EFB (Tablet), während im Hintergrund das FMGEC vorbereitet wird.

*   **Deboarding / Cargo Unloading:**
    *   *A330-200 (Pax):* Im EFB den Deboarding-Prozess starten und das Absinken der Passagiere/Fracht auf Null abwarten.
    *   *A330-300P2F (Cargo):* Main Deck Cargo Door öffnen und ULD Container Unloading via EFB/GSX veranlassen.
...
*   **Boarding / Cargo Reloading für das Folgesegment:**
    *   Sobald das Refueling abgeschlossen ist und die neuen Passagier- bzw. Frachtdaten geladen sind, den **Boarding**- bzw. **Cargo Loading**-Prozess starten.
...
Sobald die MCDU-Programmierung abgeschlossen ist, das Boarding/Cargo Loading dem Ende zugeht und das Cockpit vorbereitet ist, erfolgt der Übergang zurück in die reguläre [Standard Operating Procedures (SOP)](sop.md):

*   **Nahtloser Anschluss:** 
    *   Abschließende Schritte des Boardings/Cargo Loadings durchführen (Schließen der Türen / Main Deck Cargo Door über das EFB).
